@php
    ...
    $informationId = $information ? $information->id : 2;
    $informationTitle = $information ? $information->title : 'Lomba UI/UX Design Nasional';
@endphp
<!DOCTYPE html>
<html lang="en">
<head>
        ...
        <div class="w-full bg-white/90 border border-[#898383]/30 rounded-2xl p-6 shadow-sm flex flex-col md:flex-row justify-between items-center gap-6 relative z-10 backdrop-blur-sm" data-aos="fade-up">
            <div class="flex flex-col md:flex-row items-start md:items-center w-full justify-between gap-6 md:gap-0">
                ...
                <div class="w-full md:flex-1 flex items-center gap-4 md:pl-4 lg:pl-8">
                    ...
                    <div>
                        <div class="text-[16px] md:text-[19px] font-medium text-[#898383]">Anggota Tim</div>
                        <div class="text-[16px] md:text-[19px] font-medium text-[#273266]">Individu / Tim</div>
                    </div>
                </div>
                ...
                <div class="w-full md:flex-1 flex items-center gap-4 md:pl-4 lg:pl-8">
                    ...
                    <div>
                        <div class="text-[16px] md:text-[19px] font-medium text-[#898383]">Kategori Lomba</div>
                        <div class="text-[16px] md:text-[19px] font-medium text-[#273266]">Nama Kategori</div>
                    </div>
                </div>
            </div>
        ...
        <div class="mt-20 flex flex-col lg:flex-row gap-16 lg:gap-24 items-stretch">
            ...
            <div class="w-full lg:w-2/3 flex flex-col justify-between" data-aos="fade-left" data-aos-delay="100">
                ...
                <div class="flex flex-col flex-1">
                    <h1 class="text-[30px] font-semibold text-[#486284] mb-6 text-center lg:text-left">Deskripsi Kompetisi</h1>
