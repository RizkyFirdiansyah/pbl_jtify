@php
    $informationId = $information ? $information->id : 3;
    $informationTitle = $information ? $information->title : 'Seminar AI & Technology';
...
<head>
    ...
    <title>Detail Seminar - {{ $informationTitle }}</title>
    ...
    <main class="max-w-[1440px] mx-auto px-6 lg:px-20 pt-8 pb-0">
        ...
        <div class="w-full bg-white/90 border border-[#898383]/30 rounded-2xl p-6 shadow-sm flex flex-col md:flex-row justify-between items-center gap-6 relative z-10 backdrop-blur-sm" data-aos="fade-up">
            <div class="flex flex-col md:flex-row items-start md:items-center w-full justify-between gap-6 md:gap-0">
                ...
                <div class="w-full md:flex-1 flex items-center gap-4 md:pl-4 lg:pl-8">
                    <div class="text-[#555555]">
                        <svg width="25" height="25" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <rect x="2" y="6" width="20" height="12" rx="2" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></rect>
                            <circle cx="12" cy="12" r="2" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></circle>
                            <path d="M6 12h.01M18 12h.01" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path>
                        </svg>
                    </div>
                    <div>
                        <div class="text-[16px] md:text-[19px] font-medium text-[#898383]">Biaya Pendaftaran</div>
                        <div class="text-[16px] md:text-[19px] font-medium text-[#273266]">gratis/rp.xx.xxx</div>
                    </div>
                </div>
                ...
                <div class="w-full md:flex-1 flex items-center gap-4 md:pl-4 lg:pl-8">
                    ...
                    <div>
                        <div class="text-[16px] md:text-[19px] font-medium text-[#898383]">Lokasi</div>
                        <div class="text-[16px] md:text-[19px] font-medium text-[#273266]">lokasi pelaksanaan</div>
                    </div>
                </div>
            </div>
        ...
        <div class="mt-32 mb-6">
            <div class="flex items-center justify-between px-2">
                <div>
                    <h2 class="text-2xl md:text-3xl font-bold text-[#486284]">Seminar Menarik Lainnya</h2>
                    <p class="text-sm md:text-base text-gray-500 mt-1">Temukan wawasan baru di seminar pilihan kami</p>
                </div>
                <a href="{{ route('seminar') }}" class="hidden md:flex text-sm text-gray-400 font-bold hover:text-[#3B4C7E] transition items-center gap-1">
                    Lihat semua
            ...
            <div class="mt-6 slider-wrapper flex-1" id="sliderWrapper">
                <div class="slider-track cursor-grab active:cursor-grabbing select-none" id="sliderTrack">
                    ...
                    <div class="card-item flex-none" style="width: 260px;"
                        ...
                        <a href="{{ route('seminar.detail', ['id' => $rec->id]) }}"
                           style="height: 380px;"
                    ...
                    <div class="w-full text-center py-8 text-gray-400">
                        Tidak ada seminar menarik lainnya.
                    </div>
                    @endforelse
                </div>
            </div>
