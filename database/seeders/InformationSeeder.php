            ...
            foreach ($titles as $index => $title) {
                Information::updateOrCreate(
                    ...
                    [
                        ...
                        'registration_link' => 'https://devel-jti.polinema.ac.id/' . Str::slug($title),
                        'guidebook_link' => 'https://docs.google.com/document/d/1ff908mV1TuCCSksGZTWVBRaBFaQre5DcV4vpWa_nguw/edit?usp=sharing' . Str::slug($title),
                        'poster_path' => 'posters/poster' . rand(1,2). '.png',
                        'status' => 'published',
                        'approved_by' => $adminId,
